...
int32_t FunctionServlet::handle(ucc::http::HttpRequest::ptr request,
...
int32_t ServletDispatch::handle(ucc::http::HttpRequest::ptr request,
				ucc::http::HttpResponse::ptr response,
				ucc::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(ucc::http::HttpRequest::ptr request,
				ucc::http::HttpResponse::ptr response,
				ucc::http::HttpSession::ptr session){

	static const std::string& RSP_BODY = "<html><head><title>404 Not Found"
		"</title></head><body><center><hl>404 Not Found</hl></center>"
		"<hr><center>ucc/1.0.0</center></body></html>";

	response->setStatus(ucc::http::HttpStatus::NOT_FOUND);
	response->setHeader("Server", "ucc/1.0.0");
